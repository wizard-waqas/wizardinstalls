                    ...
                    <Popover className="relative">
                        ...
                        <PopoverPanel anchor="bottom" className="flex flex-col">
                            ...
                            <p className={"bg-grey-400 border-2 border-grey-800 mx-8 pt-8 px-4 pb-4 rounded-lg"}>
                                Mobile service is included for residents in Jersey City and Woodbridge, New Jersey.&nbsp;
                                For areas outside of this, we may travel for an additional charge.&nbsp;
                                Tap the <i>zipcode</i> button to check the cost of servicing your area.
                            </p>
                        </PopoverPanel>
                    </Popover>

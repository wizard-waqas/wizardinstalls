...
export default function YouShouldKnow() {
    return (
        <div className="flex flex-col items-center">
            <div className="mt-6 max-w-xl flex flex-col items-center text-center text-white">
                <h4 className="text-2xl font-bold mb-2 text-gray-300">You should know:</h4>

                <ul className="flex flex-col space-y-4 w-11/12 lg:w-full">
                    <li className={"bg-grey-400 p-4 rounded-lg flex justify-center items-center leading-[1.75]"}>
                        <span>
                    ...
                    <li className={"bg-grey-400 p-4 rounded-lg flex justify-center items-center"}>
